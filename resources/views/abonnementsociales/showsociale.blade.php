...
@section('content')
            ...
            width: 50px;margin-bottom: 250px; ">
                ...
                <div class="col-12 mb-1"  style="font-family: initial;color: black;text-align: center" >
                    <p class="mb-0"><b>
                            ...
                            {{str_replace('.',',',$abonnementsociale->annee->nom)}}
                        </b>
                    </p>
                </div>
                ...
                <div class="row" style="font-family: initial;color: black;">
                    <div class="col-4 float-left">
                        <div class="row text-center  pull-left" style="margin-left: -36px;" >
                            ...
                            <div class="col-12 mb-1" >
                                <img style="width: 95px;height: 85px;border-radius: 32px;" src="{{asset('images')}}/{{$abonnementsociale->profileimage}}" style="max-height:60px;">
                            </div>
                            <div class="col-12 ">
                                <p class="mb-0"><b>
                                        الثمن
                                        {{str_replace('.',',',$abonnementsociale->prixtotale)}}
                                    </b>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-8 float-right" style="padding-right: 0px;margin-top: -19px">
                        <div class="row text-right" style="font-size: 15px;margin-top: 98px;">
                            <div class="col-12">
                                <p style="margin-bottom: 0!important;">
                                    <b>{{$abonnementsociale->nom}}{{ $abonnementsociale->prenom}}</b>
                                    <b> :الاسم واللقب </b>
                            ...
                            <div class="col-12">
                                <div style="margin-bottom: 0!important;">
                                    ...
                                    <div>
                                        ...
                                        <strong style="font-size: 16px">  {{$abonnementsociale->etudiant->nom}} </strong>
                                        تاریخ الولادة  :

                                        <strong style="font-size: 16px">   {{$abonnementsociale->datenaissance}} </strong>
                                        :الصنف
                            ...
                            <div class="col-12">
                                <p style="margin-bottom: 0!important;">
                                    ...
                                    {{ $abonnementsociale->periodeabonnement->periode}}
                                    <b>:صالحة </b>
                                </p>
                            </div>
                            <div class="col-12">
    ...
    <div class="row ">
        <div class="col-md-6 mx-auto">
            <div class="d-flex justify-content-center">
                <div class="p-2">
                    <a href="{{route('getAllAbonnementsociale')}}" class="btn btn-lg btn-success">{{__('Imprimer')}}</a>
                </div>

                <div class="p-2">
                    <a href="{{route('indexabonnementsociale')}}" class="btn btn-lg btn-danger">{{__('retour')}}</a>
                </div>
            </div>
        </div>
    </div>
