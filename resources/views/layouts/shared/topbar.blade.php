...
{{--            </li>--}}
            ...
            <li class="dropdown d-inline-block ">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light"  href="{{route('addabonnementscolaire')}}" role="button" aria-haspopup="false" aria-expanded="false">
                    <button type="button" class="btn btn-success waves-effect waves-light"><i class="mdi mdi-card-account-details mr-1"></i>
                        {{__('Abonnement Rapide')}}</button>
                </a>
...
{{--            </li>--}}
            ...
            <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    @if(app()->getLocale()=="fr")
                        <img src="{{asset('assets/images/flags/french.jpg')}}" alt="user-image" height="16">
                    @else
                        <img src="{{asset('assets/images/flags/tunisie.png')}}" alt="user-image" height="16">
                    @endif
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <!-- item-->
                        ...
                        <img src="{{asset('assets/images/flags/tunisie.png')}}" alt="user-image" class="mr-1" height="12">
                        <span class="align-middle">{{__('Arabe')}}</span>
                        @else
                            <a href="{{url('/locale/fr')}}" class="dropdown-item">
                            <img src="{{asset('assets/images/flags/french.jpg')}}" alt="user-image" class="mr-1" height="12">
                            <span class="align-middle">{{__('Francais')}}</span>
                        @endif
                    </a>
                </div>
            </li>
...
{{--            </li>--}}
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    @endhasrole
                    @hasrole('supervisor')
                    <img src="{{asset('assets/images/supervisor.png')}}" alt="user-image" class="rounded-circle">
                    @endhasrole
                    @hasrole('user')
...
{{--            </li>--}}
        ...
        <div class="logo-box">
            <a href="{{route('home')}}" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="{{asset('storage/topbar.png')}}"alt="" height="20">
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-lg">
                    <img src="{{asset('storage/topbar.png')}}"alt="" height="40">
