            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="#sidebarAgency" data-toggle="collapse">
                        ...
                        <span> {{__('Agences')}} </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarAgency">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('agencies.index')}}">{{__('Liste des Agences')}}</a>
                            </li>
                            <li>
                                <a href="{{route('agencies.create')}}">{{__('Créer une Agence')}}</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="sidebarUsers">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{route('users.create')}}">{{__('Créer un Utilisateur')}}</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="sidebarClients">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('clients.index')}}">{{__('Liste des Clients')}}</a>
                            </li>
{{--                            <li>--}}
{{--                                <a href="{{route('users.create')}}">{{__('Créer un Clients')}}</a>--}}
{{--                            </li>--}}
                        </ul>
                    </div>
                </li>
                <li>
                    <a href="#sidebarSubscription" data-toggle="collapse">
                        <i class="mdi mdi-card-account-details-outline"></i>
                        <span> {{__('Abonnements')}} </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarSubscription">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('subscriptions.index')}}">{{__('Liste des Abonnements')}}</a>
                            </li>
                            <li>
                                <a href="{{route('subscriptions.create')}}">{{__('Créer un Abonnement')}}</a>
                            </li>
                        </ul>
                        <ul class="nav-second-level">
                            <li>
                                <a href="#sidebarSubsCat" data-toggle="collapse">
                                    <i class="mdi mdi-card-bulleted-outline"></i>
                                    {{__('Catégories')}}<span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="sidebarSubsCat">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{route('subscriptionCategories.index')}}">{{__('Liste des Categories')}}</a>
                                        </li>
                                        <li>
                                            <a href="{{route('subscriptionCategories.create')}}">{{__('Créer une Categorie')}}</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                        ...
                        <ul class="nav-second-level">
                            <li>
                                <a href="#sidebarSubsPer" data-toggle="collapse">
                                    <i class="mdi mdi-update"></i>
                                    {{__('Périodes')}}<span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="sidebarSubsPer">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{route('subscriptionPeriods.index')}}">{{__('Liste des Périodes')}}</a>
                                        </li>
                                        <li>
                                            <a href="{{route('subscriptionPeriods.create')}}">{{__('Créer une Période')}}</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li>
                    <a href="#sidebarLignes" data-toggle="collapse">
                        <i class="icon-shuffle"></i>
                        <span> {{__('Lignes')}} </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarLignes">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('lines.index')}}">{{__('Liste des Lignes')}}</a>
                            </li>
                            <li>
                                <a href="{{route('lines.create')}}">{{__('Créer un ligne')}}</a>
                            </li>
                        </ul>
                        <ul class="nav-second-level">
                            <li>
                                <a href="#sidebarStation" data-toggle="collapse">
                                    <i class="mdi mdi-bus-stop-covered"></i>
                                    {{__('Stations')}}<span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="sidebarStation">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{route('stations.index')}}">{{__('Liste des Station')}}</a>
                                        </li>
                                        <li>
                                            <a href="{{route('stations.create')}}">{{__('Créer une Station')}}</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                        ...
                        <ul class="nav-second-level">
                            <li>
                                <a href="#sidebarBus" data-toggle="collapse">
                                    <i class="mdi mdi-bus"></i>
                                    {{__('Bus')}}<span class="menu-arrow"></span>
                                </a>
                                <div class="collapse" id="sidebarBus">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{route('buses.index')}}">{{__('Liste des Bus')}}</a>
                                        </li>
                                        <li>
                                            <a href="{{route('buses.create')}}">{{__('Créer un Bus')}}</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li>
                    <a href="#sidebarInstitution" data-toggle="collapse">
                        <i class="mdi mdi-school"></i>
                        <span> {{__('Etablissments')}} </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarInstitution">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('institutions.index')}}">{{__('Liste des Etablissements')}}</a>
                            </li>
                            <li>
                                <a href="{{route('institutions.create')}}">{{__('Créer une Etablissement')}}</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    <a href="#sidebarStock" data-toggle="collapse">
                    ...
                    <div class="collapse" id="sidebarStock">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{route('demands.index')}}">{{__('Liste des Demandes')}}</a>
                            </li>
                            <li>
                                <a href="{{route('deliveries.index')}}">{{__('Liste des livraison')}}</a>
                            </li>
                            <li>
                                <a href="{{route('declarations.index')}}">{{__('Liste des Retour')}}</a>
                            </li>
{{--                            <ul class="nav-second-level">--}}
{{--                                <li>--}}
{{--                                    <a href="#sidebarSubsCat" data-toggle="collapse">--}}
...
{{--                                        <ul class="nav-second-level">--}}
{{--                                            <li>--}}
{{--                                                <a href="{{route('returns.index')}}">{{__('Liste des Retour')}}</a>--}}
{{--                                            </li>--}}
{{--                                        </ul>--}}
{{--                                    </div>--}}
{{--                                </li>--}}
