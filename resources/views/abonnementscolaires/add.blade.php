    ...
    <div id="wrapper">
        ...
        <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-12">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Ajouter un Abonnement Scolaire </h1>

            </div>
            <form action="{{route('storeabonnementscolaire')}}" method="post" enctype="multipart/form-data">
                @csrf
                @if($errors->any())
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group mb-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="prenomabonne" class="form-control" id="prenomabonne" name="prenomabonne" value="{{old('prenomabonne')}}">
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group mb-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="datenaissance" name="datenaissance" value="{{old('datenaissance')}}"maxlength="10" placeholder="mm/dd/yyyy" onkeyup="getAgeVal(0)" onblur="getAgeVal(0)";>
                                    ...
                                    <div class="form-group mb-3 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="age" name="age" value="{{old('age')}}"autocomplete="off">
                                            <button type="button" onclick="myFunction()">Verifier age</button>
                    ...
                    <div class="col-lg-12">
                        <div class="card" style="border: 3px solid #e5e8eb !important;border-radius: 25px;">
                            <div class="card-body">
                                    ...
                                    <div class="form-group mb-3 col-md-6">
                                        ...
                                        <select class="form-control form-control-lg" id="annee_id" name="annee_id" >
                                            @foreach($annees as $annee)
                                                <option {{ old('annees_id') == $annee->id ? "selected" : "" }}
                                ...
                                <input type="button" class="btn btn-primary" id="show_menu" value="Afficher Ligne">
                                <input type="button" class="btn btn-danger" id="hide_menu" value="Masquer ligne">

                                <div class="list_container" style="display:none">
                                    <div class="row">
                                    <div class="form-group mb-3 col-md-3">
                                    <label for="ligne_id">Numero Ligne</label>
                                    ...
                                    <div class="form-group mb-3 col-md-3">
                                        <label for="ligne_id">Ligne debut</label>
                                        <select class="form-control form-control-lg" id="ligne_id" name="ligne_id" >
                                            @foreach($lignes as $ligne)
                                                <option {{ old('ligne_id') == $ligne->id ? "selected" : "" }}
                                                        value="{{$ligne->id}}">{{$ligne->lignedebut}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <div class="form-group mb-3 col-md-3">
                                            ...
                                            <select class="form-control form-control-lg" id="ligne_id" name="ligne_id" >
                                                @foreach($lignes as $ligne)
                                                    <option {{ old('ligne_id') == $ligne->id ? "selected" : "" }}
                                                            value="{{$ligne->id}}">{{$ligne->lignefin}}</option>
                                                @endforeach
                                            </select>
                                        </div>

                                        <div class="form-group mb-3 col-md-3">
                                            <label for="ligne_id">prix</label>
                                            <select class="form-control form-control-lg" id="ligne_id" name="ligne_id" >
                                                @foreach($lignes as $ligne)
                                                    <option {{ old('ligne_id') == $ligne->id ? "selected" : "" }}
                                                            value="{{$ligne->id}}">{{$ligne->prix}}</option>
                                                @endforeach
                                            </select>
                                        </div>
